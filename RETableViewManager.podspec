Pod::Spec.new do |s|
  ...
  s.platform = :ios, '6.0'
  s.requires_arc = true
  s.source_files = 'RETableViewManager/Cells', 'RETableViewManager/Items', 'RETableViewManager/REFormattedNumberField', 'RETableViewManager'
  s.public_header_files = 'RETableViewManager/Cells/*.h', 'RETableViewManager/REFormattedNumberField/*.h', 'RETableViewManager/*.h', 'RETableViewManager/Items/*.h'
